#!/bin/bash
# node-control-tr (192.168.58.5) — Ansible control-node для cluster-tiers.
# Управляет: node-gitlab-tr / node-redmine-tr / node-mattermost-tr.
...
TARGETS=("192.168.58.10" "192.168.58.20" "192.168.58.30")
...
[gitlab_hosts]
node-gitlab-tr ansible_host=192.168.58.10

[redmine_hosts]
node-redmine-tr ansible_host=192.168.58.20

[mattermost_hosts]
node-mattermost-tr ansible_host=192.168.58.30
...
echo ""
echo "[node-control-tr] provisioning done — cluster-tiers scenario=$SCENARIO"
